...
//                $url = "http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS03Alias";  De reserva
                ...
                //RUC COMPLETO //por si ya no funcione el 00
//                $patron = '/<td width="18%" colspan=1  class="bgn">RUC:[ ]*<\/td>\r\n[\t]*[ ]+<td  class="bg" colspan=3>(.*)<\/td>/';
//                $output = preg_match_all($patron, $Page, $matches, PREG_SET_ORDER);
//                if (isset($matches[0])) {
//                    //rtn["COMPLETO"] = trim($matches[0][1]);
//                    $explode = explode('-', trim($matches[0][1]));
////                    $rtn["ruc_numero"] = $explode[0];
//                    $rtn["RazonSocial"] = $explode[1];
//                }
