            ...
            {foreach from=$aperturas_cajas item='aperturas_caja'}
                ...
                <div class="row">
                    ...
                    <table width="100%" class="table" id="tabla_datos_apertura_{$aperturas_caja.id_pos_arqueoscaja}">
                        ...
                        {if count($aperturas_caja.ingresos)}
                            <tr class="info">
                                <td style="text-align: center; font-size: 1.25em" colspan="6">
                                    <strong>
                            ...
                            {assign var='total' value=0}
                            {assign var='nro_operaciones' value=0}
                            {foreach from=$aperturas_caja.ingresos item='detail'}
                        ...
                        <tr class="warning">
                            <td style="text-align: right; font-weight: bold; font-size: 1.75em"  colspan="6">Saldo en Caja: {displayPrice currency=1 price=($suma_ingresos + $suma_adelantos + $suma_efectivo + $aperturas_caja.monto_apertura) - $suma_egresos|round:2}</td>
                        </tr>
